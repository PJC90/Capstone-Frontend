...
const handleRefresh = () =>{
 ...
 {/* Se non hai negozi compare una schermata per aprire un nuovo negozio */}
                    <Row className="mt-5 ms-1" >
                        ...
                        <Button className="my-3 rounded-pill icon-effect"><XCircleFill/> Elimina Profilo</Button>
                        </Col>
                            ):(
                                <Col>
